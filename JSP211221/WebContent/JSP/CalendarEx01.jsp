...
<style type="text/css">
	...
	th { border: 1px solid gray; width: 100px; padding: 10px; background-color: silver;}
	td { border: 1px solid gray; width: 100px; padding: 10px;}
...
<body>
	<%
		...
		// 사용자가 쿼리값을 임의로 변경하여 유효하지 않은 값을 만들었다면 보정을 해주어야 한다.
		if(month==0){
			month = 12;
			year--;
		}
		...
		<tr>
			<%
				...
				if(dayOfWeekNumber==6){ // 토요일이면
					out.println("</tr>"); // 줄닫고
					if(i!=lastDay){	// 마지막 날짜가 토요일이 아니면 다음줄이 있다
					out.println("<tr>"); // 줄열고
