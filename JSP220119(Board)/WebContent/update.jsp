...
<table class= "table table-striped">
	<thead>
		<tr>
			<th colspan="4" class="title" scope="col">자유게시판 수정하기</th>
		</tr>
		<tr>
			<td colspan="3" style="border: none;"></td>
			<td style="border: none;">
				<input type="button" id="but" class="btn btn-outline-success btn-sm"
				onclick='sendPost("index.jsp",{"p" : ${p },"s" : ${s },"b" : ${b }})' value="취소">
				<input type="submit" id="but" value="수정" class="btn btn-outline-success btn-sm" />
			</td>
		</tr>
	</thead>
		 <tr>
		...
		<tr>
			<th class="item">내용</th>
			<td colspan="3">
				<textarea name="content" id="content" rows="10" cols="93">${vo.content }</textarea>
			</td>
	    </tr>
	</table>
	</form>
